...
<body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8">
                        <form action="../controller/signup.php" method="post" role="form" class="form">
                            <h5>Datos para ingresar a tu cuenta</h5>
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="user" id="user" placeholder="Un nombre de usuario (no se podrá modificar)" required 
  pattern="[A-Za-z].{4,}" title="Debe contener sólo letras y al menos 4 caracteres">
                                <div class="messages"></div>
                            </div>
                            <div class="form-group mt-3">
                                <input type="password" class="form-control" name="pass" id="pass" placeholder="Una contraseña" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
  title="Debe contener al menos un número, una mayúscula y una minúscula, y al menos 8 o más caracteres">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="id_tipo" id="musica" value="1">
                                <label class="form-check-label" for="musica">Música</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="id_tipo" id="visual" value="2">
                                <label class="form-check-label" for="visual">Artes visuales</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="id_tipo" id="letras" value="3">
